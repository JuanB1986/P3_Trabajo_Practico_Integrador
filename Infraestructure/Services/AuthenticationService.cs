...
namespace Infraestructure.Services
{
    public class AuthenticationService
    {
        ...
        public AuthenticationService(IDriverRepository driverRepository, IOptions<AutenticacionServiceOptions> options)
        {
        ...
        private User? ValidateUser(AuthenticationRequest authenticationRequest)
        {
            ...
            var user = _driverRepository.GetDriverByName(authenticationRequest.UserName);
        
            if (user == null) return null;  //lanzar excepcion notFoundException o runtimeException

          //  if (authenticationRequest.UserType == typeof(Driver).Name)
            {
